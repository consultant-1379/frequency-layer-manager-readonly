...
Log.init("Percentage_ENDC_User_Screener", executionId);
Log.i("Starting Task Execution on " + Log.getInstanceName() + " State");

var sourceCellAndScreenedTargetCells = ENDCUserRuleScnCell.sourceCellAndScreenedTargetCells(sourceCells, sectorId);

...
Log.init("LowConnectedUsers_Screener", executionId);
Log.i("Starting Task Execution on " + Log.getInstanceName() + " State");

var sourceCellAndScreenedTargetCells = LowConnectedUsersScreening.screenedSourceAndTargetCells(sourceCells, sectorId);

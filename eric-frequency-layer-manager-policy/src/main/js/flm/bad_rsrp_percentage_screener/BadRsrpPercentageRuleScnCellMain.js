...
Log.init("Bad_RSRP_Percentage_Screener", executionId);
Log.i("Starting Task Execution on " + Log.getInstanceName() + " State");

var sourceCellAndScreenedTargetCells = BadRsrpPercentageRuleScnCell.sourceCellAndScreenedTargetCells(sourceCells, sectorId);

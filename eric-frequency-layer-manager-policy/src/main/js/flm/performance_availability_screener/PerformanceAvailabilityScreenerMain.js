...
Log.init("Performance_Availability_Screener", executionId);
Log.i("Starting Task Execution on " + Log.getInstanceName() + " State");

var sourceCellAndScreenedTargetCells = performanceAvailabilityRuleScnCell.sourceCellAndScreenedTargetCells(sourceCells, sectorId);
var proceedWithOptimization = sourceCellAndScreenedTargetCells.length != 0;

Log.setInstanceName("PerformanceAvailabilityScreener");

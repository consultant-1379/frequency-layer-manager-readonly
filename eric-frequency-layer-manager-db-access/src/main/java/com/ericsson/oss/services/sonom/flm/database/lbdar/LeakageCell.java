...
/**
 * A POJO class used to store leakage cell information.
 */
public class LeakageCell {

    private final String fdn;
    private final int ossId;

    public LeakageCell(final String fdn, final int ossId) {
        this.fdn = fdn;
        this.ossId = ossId;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final LeakageCell that = (LeakageCell) o;

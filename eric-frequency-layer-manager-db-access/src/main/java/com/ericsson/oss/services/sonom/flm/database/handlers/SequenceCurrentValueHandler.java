 ...
 */
public class SequenceCurrentValueHandler implements ResultHandler<Integer> {
    private static final String LAST_VALUE = "last_value";

    /**
     * Gets the actual sequence value from the database.
     *
     * @param resultSet
    ...
    public Integer populate(final ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            lastSequenceValue = resultSet.getInt(LAST_VALUE);
        }

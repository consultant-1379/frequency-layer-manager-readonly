...
/**
 * Handles the {@link ResultSet} for an inserted {@link PaPolicyOutputEvent}.
 */
public class PAOutputEventInsertHandler implements ResultHandler<String> {
    /**
     ...
     * @return The pa_execution_id of the new {@link PaPolicyOutputEvent}.
     * @throws SQLException
    ...
    public String populate(final ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            paExecutionId = resultSet.getString(PAExecutionDbConstants.PA_EXECUTION_ID);
        }

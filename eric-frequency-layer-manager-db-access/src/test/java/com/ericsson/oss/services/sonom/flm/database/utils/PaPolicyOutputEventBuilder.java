...
/**
 * The class is used to build test data for PA policy output event.
 */
public class PaPolicyOutputEventBuilder {
    ...
    private PaPolicyOutputEventBuilder() {

    }

    public static PaPolicyOutputEvent buildPaPolicyOutputEvent(final String flmExecutionId, final String paExecutionId, final String sectorId) {
        return new PaPolicyOutputEvent(flmExecutionId, paExecutionId, PA_WINDOW, getSector(sectorId), getDegradationStatus());
    }

    public static DegradationStatus getDegradationStatus() {
    ...
    public static Sector getSector(final String sectorId) {
